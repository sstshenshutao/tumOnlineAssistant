...
@Aspect public class TumOnlineVisitCardAspect {

  private static int SLEEP_TIME = 300;
  private Logger logger;

  public TumOnlineVisitCardAspect (MegaLogger megaLogger) {
    this.logger = megaLogger.getLogger();
  }

  @Pointcut("execution(* com.cybertaotao.robot.campus.program.TumOnlineVisitCard.run*(..))")
  void runAspect () {
  }
